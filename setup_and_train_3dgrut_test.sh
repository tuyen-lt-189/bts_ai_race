...
# HARD GPU LOCK:
# Always use physical GPU 1. CUDA exposes it as logical cuda:0 to PyTorch.
...
echo "Physical GPU ID  : 1 (hard-locked)"
...
def main() -> None:
    ...
    if GPU_ID != 1:
        fail(
            f"This launcher is hard-locked to physical GPU 1, got GPU_ID={GPU_ID}."
        )
...
run_training() {
    ...
    echo "PyTorch GPU          : cuda:0 (mapped from physical GPU 1)"
